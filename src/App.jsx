    ...
    <>
      <div className="container h-full ">
        ...
        <div className="container flex flex-row ">
          ...
          <section className="flex-auto h-full w-screen mx-5 sm:mx-0 md:mx-0 lg:mx-0 ">
            <div className=" hidden sm:flex justify-end items-center  p-1 bg-white">
            ...
            <div className="sm:hidden w-full h-10 mt-2 rounded-lg bg-gradient-to-r from-blue-400 via-yellow-200 to-yellow-200 shadow-lg flex justify-center items-center">
             <div className="flex justify-between items-center p-1  bg-white w-[99%] h-[92%] rounded-lg">
             <h1 className="text-xs font-medium">
                How many Students we helped?
              </h1>
              <button className="text-xs font-medium text-orange-400 bg-orange-100 p-1 rounded-xl px-2 ">
                Check
              </button>
             </div>
            ...
            <div className="w-full sm:mt-2 mt-5 flex justify-between items-center mb-4">
              <div className="graph bg-white sm:mx-0 md:mx-0 sm:ml-3 md:ml-10 w-full sm:w-[65%] md:w-[65%] lg:w-[65%]  h-64 sm:h-60 rounded-md shadow-lg py-1 px-2">
                ...
                <h1 className="sm:hidden bg-yellow-100 rounded-md p-1 px-2 text-xs mt-3 ">
                  {/* eslint-disable-next-line */}
                  <span className=" text-teal-400 text-sm ">Wow!</span> you're
                  about to reach your targeted band{" "}
                </h1>
            ...
            <div className="w-full sm:mt-2 mt-5 gap-x-2 flex justify-between flex-col sm:flex-row mb-4 relative">
              <div className=" grid grid-cols-3 gap-2 sm:gap-3 md:gap-3 sm:grid-cols-3 md:grid-cols-4 sm:mx-0 md:mx-0 sm:ml-3 md:ml-10 w-full sm:w-[65%] md:w-[65%] lg:w-[65%]  h-64 sm:h-60">
             ...
             font-medium "
              ...
              <div className="hidden sm:flex flex-col gap-y-3 w-[35%] h-auto mx-3 ">
                <div className="flex justify-center items-center gap-x-1 bg-white w-full h-10 rounded-lg shadow-md">
                  ...
                  <span className=" text-slate-500 sm:text-xs md:text-base">
                    App Guide Video
                  </span>
                </div>
                <div className="w-full p-2.5 bg-white rounded-lg shadow-md">
                  ...
                  <h4 className="text-xs text-gray-400 mt-1">
                    Get the authentic IELTS exam
                  </h4>
                  <h4 className="text-xs text-gray-400">
                    experience with all four modules
                  </h4>
                  <h4 className="text-xs text-gray-400">covered!</h4>
                  <button className=" text-center rounded-2xl py-1 mb-1 mt-2 w-full bg-blue-600 text-white">
                    Start
                  </button>
                </div>
              </div>
